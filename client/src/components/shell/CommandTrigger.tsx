...
export function CommandTrigger() {
  ...
  return (
    <button
      ...
      className="flex h-8 w-full items-center gap-1.5 sm:gap-2 rounded-md border border-border bg-background px-2 sm:px-2.5 text-left text-[13px] text-muted-foreground transition-colors duration-100 hover:border-input hover:text-foreground focus-visible:border-ring focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40 touch-manipulation"
    >
